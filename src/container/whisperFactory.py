...
def create_whisper_container(whisper_implementation: str, 
    ...
    if (whisper_implementation == "whisper"):
        from src.container.whisperContainer import WhisperContainer
        ...
        from src.container.fasterWhisperContainer import FasterWhisperContainer
    ...
    elif (whisper_implementation == "stable-ts"):
        from src.container.stableTSContainer import stableTSContainer
        return stableTSContainer(model_name=model_name, device=device, compute_type=compute_type, download_root=download_root, cache=cache, models=models)
