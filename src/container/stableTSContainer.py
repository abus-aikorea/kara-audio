...
from src.container.abstractWhisperContainer import AbstractWhisperCallback, AbstractWhisperContainer

class stableTSContainer(AbstractWhisperContainer):
    ...
    def _create_model(self):
        ...
        return stable_whisper.load_model(model_path, device=self.device, download_root=self.download_root)

    def create_callback(self, language: str = None, task: str = None, 
                        prompt_strategy: AbstractPromptStrategy = None,
                        **decodeOptions: dict) -> AbstractWhisperCallback:
        """
        Create a stableTSCallback object that can be used to transcript audio files.
        ...
        Returns
        -------
        A stableTSCallback object.
        """
        return stableTSCallback(self, language=language, task=task, prompt_strategy=prompt_strategy, **decodeOptions)
...
class stableTSCallback(AbstractWhisperCallback):
    def __init__(self, model_container: stableTSContainer, language: str = None, task: str = None, 
                 prompt_strategy: AbstractPromptStrategy = None, 
                 **decodeOptions: dict):
    ...
    def _transcribe(self, model: Whisper, audio, segment_index: int, prompt: str, detected_language: str):
        ...
        whisper_result: WhisperResult = model.transcribe(audio, \
